...
attack_tid_re = re.compile("ADDENDUM TO (T\d\d\d\d)$")
attack_stid_re = re.compile("ADDENDUM TO (T\d\d\d\d.\d\d\d)")
# ATT&CK Subtechnique TID
attack_sub_tid_re = re.compile("ADDENDUM TO (T\d\d\d\d\.\d\d\d)")
attack_sub_tid_re2 = re.compile("ADDENDUM TO (T\d\d\d\d)\.(\d\d\d)")
types = [
         "fight_technique",                           #0
