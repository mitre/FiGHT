...
fight_url = "http://10.128.7.50/techniques"
...
subtechlabels = [
    ...
    "##### This is an ATT&CK Technique that has one or more FiGHT Subtechniques, or ATT&CK Subtechniques with FiGHT Addendums." #5
